...
@section('content')
  ...
  <div class="top-posts-container">
    ...
    @endphp
      ...
      <img src="{{ asset('storage/' . $firstPhoto) }}" alt="{{ $post->title }}" class="post-image-preview">
      </div>
      @endif
      <!-- Конец исправлений -->
  ...
  <style>
    ...
    width: 100%;
    height: 500px;
    /* Увеличена высота с 200px до 300px */
    object-fit: cover;
    border-radius: 8px;
    ...
    height: auto;
    filter: invert(30%);
    /* Темно-красный цвет для иконки лайка */
    }
